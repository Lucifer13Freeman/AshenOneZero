...
{
    comment_body_ref: React.RefObject<any>;
    
    constructor(props:any)
    {
        super(props);
        this.comment_body_ref = React.createRef();
    }

    componentDidMount()
    {
        this.comment_body_ref.current.innerHTML = this.props.comment.body;
    }

    on_delete = () => 
    { 
        this.props.remove_comment(this.props.post_id ,this.props.comment._id); 
    }
        ...
        return(
            <div className="card mb-3">
                <div className="card-body">
                            ...
                            <div className="d-flex justify-content-between align-items-center">
                                <div className="d-flex justify-content-between align-items-center">
                                    ...
                                    <div className="ml-2">
                                        ...
                                        <div className="h7 text-muted">
                                            <i className="fa fa-clock-o"></i> {new Date(comment.created_date).toDateString()}
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <hr />
                    <div className="row">
                        <div className="col-md-12" ref={this.comment_body_ref}></div>
                    </div>
                </div>
            </div>
        );
    ...
    static propTypes: { 
        remove_comment: PropTypes.Validator<(...args: any[]) => any>; 
        auth: PropTypes.Validator<object>; 
        comment: PropTypes.Validator<object>; 
